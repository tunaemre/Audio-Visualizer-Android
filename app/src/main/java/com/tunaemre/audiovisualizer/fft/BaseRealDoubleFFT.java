...
class BaseRealDoubleFFT {

    static final double sqrt2 = Math.sqrt(2);
    static final double halfSqrt2 = sqrt2 / 2;
  ...
  -------------------------------------------------*/
    void radf4(int ido, int l1, final double cc[], double ch[], final double wtable[], int offset) {
        ...
        for (k = 0; k < l1; k++) {
            ti1 = -halfSqrt2 * (cc[ido - 1 + (k + l1) * ido] + cc[ido - 1 + (k + 3 * l1) * ido]);
            tr1 = halfSqrt2 * (cc[ido - 1 + (k + l1) * ido] - cc[ido - 1 + (k + 3 * l1) * ido]);
  ...
  --------------------------------------------------------*/
    void radbg(int ido, int ip, int l1, int idl1, double cc[], double c1[], double c2[], double ch[], double ch2[], final double wtable[], int offset) {
